...
#define T double //TODO: must also change a line in solvePhaseNaive in FractureSimulation.h (VectorXcf vs VectorXcd)
#define dim 3

namespace Minchen {
double nu = 0.4, E = 20, rho = 0.1, v = 10, dx = 0.012, M = 10, sigmaPercent = 0.02, bulletFriction = 0.1;
...
{
    {
        ...
        FLAGS::Register sigmaPercent_flag("-sigmaPercent", "sigmaPercent", Minchen::sigmaPercent);
        FLAGS::Register bulletFriction_flag("-bulletFriction", "bulletFriction", Minchen::bulletFriction);
        FLAGS::Register usePhaseField_flag("--usePhaseField", "usePhaseField", Minchen::usePhaseField);
